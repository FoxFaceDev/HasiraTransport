...
@section('content')
<div class="glass-panel p-4" x-data="gatekeeperQueueManager({{ Js::from($snapshot) }}, { exportBaseUrl: {{ Js::from(route('gatekeeper.export')) }} })" @keydown.escape.window="closeActionsModal(); closeScheduleModal()">
