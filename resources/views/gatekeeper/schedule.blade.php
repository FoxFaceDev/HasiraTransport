...
@section('content')
<div class="glass-panel p-6" x-data="gatekeeperQueueManager({{ Js::from($snapshot) }}, { scheduleOnly: true, dateFilter: {{ Js::from($date) }}, exportBaseUrl: {{ Js::from(route('gatekeeper.export')) }} })">
